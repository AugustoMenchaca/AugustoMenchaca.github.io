...
| Resposta direcional | illoca move rótulo `12px` e sublinhado pela largura; estado final observado entre 220–500ms | Adaptar para amplitude menor em ponteiro fino; manter foco parado |
